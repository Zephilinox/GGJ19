...
Shader "Skybox/Cubemap Extended"
{
	Properties
	{
		...
		_HorizonOffset("Horizon Offset", Range(-100, 100)) = 0
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex - float3(0, _HorizonOffset / 100.0, 0));
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float3 normalizeResult319 = normalize( ase_worldPos ) - float3(0, _HorizonOffset / 100.0, 0);

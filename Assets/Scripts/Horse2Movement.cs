...
public class Horse2Movement : MonoBehaviour
{
	...
	void Update ()
    {
            ...
            || GamePad.GetAxis(GamePad.Axis.LeftStick, GamePad.Index.One).x > leftJoyDeadZone)
        {
            ...
            tempMovement.x += GamePad.GetAxis(GamePad.Axis.LeftStick, GamePad.Index.Two).x * movementSpeed;
        ...
        {
            Vector3 tempMovement = this.transform.position;
            tempMovement.z += GamePad.GetAxis(GamePad.Axis.LeftStick, GamePad.Index.Two).y * movementSpeed;
            this.transform.position = tempMovement;
        }
